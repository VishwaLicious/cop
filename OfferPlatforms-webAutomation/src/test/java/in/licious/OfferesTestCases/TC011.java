...
public class TC011 extends BaseTest{
	...
	public void TC_011() throws IOException{
		...
		Map<String, String> data=r.getheaderinfo(properties.getProperty("offersCreationSheet"), "TC011");
		...
		h.customWait(3);
		String CouponCodeError=camp.getCopuonCodeExpire().getText();
		Assert.assertEquals(CouponCodeError, "Coupon code is already expired");
