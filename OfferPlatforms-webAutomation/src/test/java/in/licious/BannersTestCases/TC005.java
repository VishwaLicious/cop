...
public class TC005 extends BaseTest{
	...
	@Test
	public void TC_005() throws FindFailed, IOException{
		// Veify the banner should create with entering the utm medium 
		
		ReadExcelData r=new ReadExcelData();
		Map<String, String> data=r.getheaderinfo(properties.getProperty("BannersCreationSheet"), "TC005");
